const coffees = [
    {
      ...
      price: 14.99,
      imageUrl: "https://plus.unsplash.com/premium_photo-1682148098085-72b02a2d6604?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      rating: 4.9,
      bestSeller: true,
    ...
    },
    {
      ...
      price: 13.49,
      imageUrl: "https://images.unsplash.com/photo-1511920170033-f8396924c348?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      rating: 4.8,
      bestSeller: true,
      category: "Organic",
    ...
    },
    {
      ...
      price: 15.29,
      imageUrl: "https://images.unsplash.com/photo-1498804103079-a6351b050096?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzF8fGNvZmZlZXxlbnwwfHwwfHx8MA%3D%3D",
      rating: 4.7,
      bestSeller: true,
      category: "Single Origin",
    ...
    },
    {
      ...
      price: 16.49,
      imageUrl: "https://images.pexels.com/photos/585753/pexels-photo-585753.jpeg?auto=compress&cs=tinysrgb&w=1600",
      rating: 4.8,
      bestSeller: true,
    ...
    },
    {
      ...
      price: 14.79,
      imageUrl: "https://images.pexels.com/photos/606545/pexels-photo-606545.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      rating: 4.7,
      bestSeller: true,
      category: "Organic",
    ...
    },
    {
      ...
      price: 49.99,
      imageUrl: "https://images.unsplash.com/photo-1511537190424-bbbab87ac5eb?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      rating: 5.0,
      bestSeller: true,
      category: "Single Origin",
    ...
    },
    {
      ...
      price: 12.99,
      imageUrl: "https://images.unsplash.com/photo-1564676677001-92e8f1a0df30?q=80&w=2671&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      rating: 4.6,
      bestSeller: true,
      category: "Premium Blends",
  ...
  },
  {
    ...
    price: 14.99,
    imageUrl: "https://images.unsplash.com/photo-1610632380989-680fe40816c6?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 4.7,
    bestSeller: true,
    category: "Organic",
  ...
  },
  {
    ...
    price: 19.49,
    imageUrl: "https://images.unsplash.com/photo-1582768772255-7fb8066357ce?q=80&w=2801&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 4.8,
    bestSeller: true,
    category: "Premium Blends",
  ...
  },
  {
    ...
    price: 15.59,
    imageUrl: "https://images.unsplash.com/photo-1610889556528-9a770e32642f?q=80&w=2630&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 4.7,
    bestSeller: true,
    category: "Organic",
    notes: "Bright, citrus, honey, balanced, clean.",
    longDescription: "Ecuadorian Organic: A Natural Treasure Rooted in Biodiversity and TraditionEcuador, a small yet ecologically diverse country straddling the equator in South America, is a rising star in the global organic movement. With its rich cultural heritage and unique geographic advantages—from the Amazon rainforest to the Andes Mountains to the Pacific coast and the Galápagos Islands—Ecuador offers an ideal environment for organic farming. The term 'Ecuadorian organic' refers not only to the method of agricultural production but also to a broader ethos that combines traditional knowledge, ecological stewardship, and a commitment to health and sustainability.",
    region:"Ecuador"
  },
  {
    name: "Panama Geisha",
    ...
    price: 85.00,
    imageUrl: "https://images.unsplash.com/photo-1598685530037-feb0accd2722?q=80&w=2788&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 5.0,
    bestSeller: true,
    category: "Single Origin",
  ...
  },
  {
    ...
    price: 21.99,
    imageUrl: "https://images.unsplash.com/photo-1459755486867-b55449bb39ff?q=80&w=2669&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 4.9,
    bestSeller: true,
    category: "Single Origin",
  ...
  },
  {
    ...
    price: 39.99,
    imageUrl: "https://images.unsplash.com/photo-1587734361993-0033759da68b?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDM5fHx8ZW58MHx8fHx8",
    rating: 4.8,
    bestSeller: true,
    category: "Single Origin",
  ...
  },
  {
    ...
    price: 150.00,
    imageUrl: "https://images.unsplash.com/photo-1616672500735-7015803d497f?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 5.0,
    bestSeller: false,
    category: "Premium Blends",
    longDescription: "Kopi Luwak is one of the rarest and most unique coffees in the world, often referred to as 'civet coffee' because of its unusual production process. The beans are eaten and then excreted by the civet, a small mammal found in Southeast Asia. This process is said to contribute to its distinctive flavor profile.The unique fermentation process is thought to reduce the acidity and bitterness in the coffee, leading to a milder, smoother cup. The beans also undergo natural processing, which can result in a cleaner, more refined flavor than traditionally processed coffees.Kopi Luwak is often considered a luxury coffee, and because it’s rare and labor-intensive to produce, it typically carries a high price tag. This coffee is a favorite among those who seek a truly exotic and premium coffee experience.Kopi Luwak: The World’s Most Exotic and Controversial Coffee.Kopi Luwak: The World’s Most Exotic and Controversial Coffee.Kopi Luwak, often referred to as civet coffee, is one of the rarest, most expensive, and most debated coffees in the world. Originating in Indonesia, particularly on the islands of Sumatra, Java, and Bali, Kopi Luwak has gained global fascination not only for its luxurious price tag but also for its highly unusual production process—one that involves the digestive system of a small animal called the Asian palm civet (Paradoxurus hermaphroditus).",
    region:"Indonesia",
  ...
  },
  {
    ...
    price: 45.00,
    imageUrl: "https://images.unsplash.com/photo-1512568400610-62da28bc8a13?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 4.9,
    bestSeller: false,
    category: "Single Origin",
    notes: "Mild, creamy, floral, nutty, balanced.",
    longDescription: "Yemen Mocca: A Legendary Coffee with a Bold Heritage Yemen Mocca (often spelled Mocha, Mokha, or Mokha) is one of the most legendary and historically significant coffees in the world. Grown in the arid mountains of Yemen and named after the ancient port city of Al-Mokha, this coffee is not just a beverage—it is a piece of living history, a symbol of artisanal craftsmanship, and a treasure of the global coffee heritage. Known for its complex, winey flavors and deep, earthy undertones, Yemen Mocca is often revered as the original gourmet coffee.",
    region:"Yemen"
  }
  ];
